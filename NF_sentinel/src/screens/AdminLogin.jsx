...
const AdminLogin = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Store admin session info for the dashboard guard
  ...
  return (
    <div className="min-h-full bg-[#111] flex items-center justify-center p-4">
      <div className="max-w-sm w-full bg-[#222] rounded-[24px] border border-gray-800 p-8 text-center shadow-2xl">
        ...
        {error && (
          <div className="flex items-center gap-2 bg-red-900/30 border border-red-800/50 text-red-400 text-xs font-medium rounded-xl p-3 mb-4 text-left">
        ...
        <div className="space-y-4 text-left">
          <div>
            <label className="text-[10px] font-bold text-gray-500 uppercase ml-1">Admin Email</label>
            <input
        ...
        <button
          ...
          className="w-full bg-[#A01030] text-white py-4 rounded-xl font-bold mt-8 hover:bg-[#8a0e29] transition-all shadow-lg shadow-red-900/20 active:scale-95 flex items-center justify-center gap-2 disabled:opacity-60"
        >
          {loading ? (
