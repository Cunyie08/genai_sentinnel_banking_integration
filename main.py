...
# Agent output shapes (flat dicts - all keys at top level):
#   DispatcherAgent  → department_code, department_name, priority_level,
#                      sla_hours, confidence, routing_method, keyword_matches,
#                      reasoning, complaint_text, sentiment
#   SentinelAgent    → total_risk_score, risk_level, risk_breakdown,
#                      recommended_action, should_block, requires_challenge,
#                      confidence, policy_explanation, amount, channel,
#                      merchant_category, transaction_timestamp,
#                      fraud_explainability_trace
#   TrajectoryAgent  → primary_product, all_qualifying_products, monthly_emi,
#                      tenure_months, dsr_ratio, dsr_warning, score_range,
#                      confidence, met_criteria, unmet_criteria, is_eligible,
#                      policy_validation, loan_signal_score, monthly_inflow,
#                      salary_detected, uber_tracker, account_type,
#                      current_balance, reasoning
# """
...
# # =============================================================================
# # Output renderers  (match the ACTUAL flat dicts agents return)
# # =============================================================================

# def print_dispatcher_result(result: dict, elapsed: float) -> None:
#     """
#     DispatcherAgent returns a FLAT dict. Key fields:
#         department_code, department_name, priority_level, sla_hours,
#         confidence, routing_method, keyword_matches, reasoning,
...
#     """
#     SentinelAgent returns a FLAT dict. Key fields:
#         total_risk_score, risk_level, risk_breakdown (dict),
#         recommended_action, should_block, requires_challenge,
#         confidence, policy_explanation, ml_probability,
#         amount, channel, merchant_category, merchant_name,
#         transaction_timestamp, fraud_explainability_trace
#     """
...
#     """
#     TrajectoryAgent returns a FLAT dict (NOT nested). Key fields:
#         primary_product, all_qualifying_products, monthly_emi,
#         tenure_months, dsr_ratio, dsr_warning, score_range,
#         confidence, met_criteria, unmet_criteria, is_eligible,
#         policy_validation (dict), loan_signal_score, monthly_inflow,
#         salary_detected, uber_tracker, account_type, current_balance,
#         reasoning
#     """
#     # Error case
...
#     # policy_validation is a sub-dict from the RAG gate
...
# NUM_ROWS   = 1     # how many rows to run
# ROW_OFFSET = 0     # skip this many rows in the DB (0 = start from row 1)
# TEST_CUSTOMER_ID = "bb5d2e1b-25bc-4314-ac35-6377ad2669cf"  # override Trajectory customer
...
# ) -> dict:
#     """
#     Run all three agents for one row of IDs sourced from the database.
#     All IDs are guaranteed to exist - fetched from the DB in main().
#     """
#     summary = {
#         "idx":           row_num,
#         "dispatcher":    "skip",
...
#     # ── Pull IDs directly from the DATABASE (guarantees they exist) ─────────────
...
#             complaint_ids[idx],
#             transaction_ids[idx],
#             TEST_CUSTOMER_ID,   # always test this specific customer for Trajectory
#             idx + 1,
#         )
