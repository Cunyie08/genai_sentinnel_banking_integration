  ...
  return (
    <div className="min-h-full w-full bg-[#F8F9FB] font-sans">
      ...
      <div className="w-full px-4 sm:px-6 xl:px-8 py-6 max-w-2xl xl:max-w-none space-y-5">
        ...
        {/* Profile card */}
        <div className="bg-gradient-to-br from-[#9F1239] to-[#881337] rounded-2xl p-6 text-white shadow-lg shadow-red-900/20 relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 relative z-10">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white/70 text-xs truncate">{user?.email || 'reuben@nexa.ng'}</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <SettingRow icon={FileText}   label="Statements"            sublabel="Download account statement" action={() => dispatch(setRoute('history'))} />
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <SettingRow icon={HelpCircle} label="Contact Us"     sublabel="Chat with support"      action={() => dispatch(setRoute('chat'))} />
