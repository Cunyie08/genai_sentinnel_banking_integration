...
import { setRoute, triggerWelcome } from '../features/uiSlice';
import {
  Eye, EyeOff, Fingerprint, Lock, ChevronRight,
  AlertCircle, ShieldCheck, Globe, Share2,
  Zap, TrendingUp, Users, CheckCircle
} from 'lucide-react';
...
const BrandPanel = ({ isLogin }) => {
  const features = [
    ...
    { icon: Users,      text: '2 million+ Nigerians trust Nexa'     },
  ];

  return (
    <div className="hidden lg:flex flex-col w-[44%] xl:w-[42%] 2xl:w-[40%] h-full shrink-0 bg-gradient-to-br from-[#9F1239] via-[#8a0f2e] to-[#5a0a1e] relative overflow-hidden">
      {/* Decorative blobs */}
      ...
      <div className="relative z-10 flex flex-col h-full p-10 xl:p-12 2xl:p-16">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="w-10 h-10 xl:w-11 xl:h-11 bg-white/15 rounded-2xl flex items-center justify-center border border-white/20 backdrop-blur-sm shrink-0">
            <span className="text-white font-black text-lg xl:text-xl">N</span>
          </div>
          <div>
            <span className="text-white font-extrabold text-xl xl:text-2xl tracking-tight leading-none block">NEXUS</span>
        ...
        <div className="flex-1 flex flex-col justify-center py-8">
          ...
          <p className="text-white/60 text-sm xl:text-base leading-relaxed max-w-xs mb-8 xl:mb-10">
            {isLogin
              ...
              : 'Join 2 million+ Nigerians who trust Nexa for fast, secure everyday banking.'}
          </p>
...
const AuthScreens = () => {
  ...
  return (
    /*
      h-[100dvh] — full viewport height, this component owns it entirely.
      flex-row on lg+ creates the split-panel.
      flex-col on mobile makes it a single scrollable column.
    */
    <div className="h-[100dvh] w-full flex flex-col lg:flex-row overflow-hidden font-sans">
      ...
      {/* ── RIGHT FORM PANEL ───────────────────────────────────────────────── */}
      {/*
        flex-1 min-w-0 ensures it fills ALL remaining space on desktop.
        overflow-y-auto lets the form scroll on small heights.
        bg-white on desktop, light gray on mobile.
      */}
      <div className="flex-1 min-w-0 flex flex-col bg-[#F9FAFB] lg:bg-white overflow-y-auto">
        ...
        <div className="lg:hidden flex items-center gap-2.5 px-6 pt-8 pb-2 shrink-0">
          <div className="w-8 h-8 bg-[#9F1239] rounded-xl flex items-center justify-center shrink-0">
            <span className="text-white font-black text-sm">N</span>
          </div>
          <div>
            <span className="text-[#9F1239] font-extrabold text-base tracking-tight leading-none block">NEXA</span>
            <span className="text-gray-400 text-[9px] font-bold uppercase tracking-widest">Fintech</span>
          </div>
        </div>

        {/* Form area — vertically centered on desktop */}
            ...
            {isLogin ? (
              ...
              <>
                ...
                <form onSubmit={handleLogin} className="space-y-5 au au3">
                  ...
                  <div>
                    ...
                    <div className={passWrap}>
                      <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none"><Lock size={18} /></div>
                ...
                <p className="text-sm text-gray-500 mt-6 text-center au au5">
                  ...
                  <button onClick={() => setView('signup')} className="text-[#A01030] font-bold hover:underline">
                    Create Account
                  </button>
                </p>
              ...
              <>
                ...
                <div className="au au1 mb-7 xl:mb-8">
                  ...
                  <h2 className="text-2xl sm:text-3xl xl:text-4xl font-black text-gray-900 leading-tight mb-2">
                    Create your<br />Nexa account
                  </h2>
                  <p className="text-gray-500 text-sm xl:text-base leading-relaxed">
                    Join millions of Nigerians managing their money smarter with Nexa.
                  </p>
                </div>

                <div className="space-y-5 au au3">
                  ...
                  <button type="button"
                    className="w-full bg-[#A01030] text-white py-4 rounded-2xl font-bold text-sm xl:text-base shadow-xl shadow-red-900/20 hover:bg-[#850d28] transition-all flex items-center justify-center gap-2 active:scale-95">
                ...
                <p className="text-sm text-gray-500 mt-6 text-center au au5">
                  ...
                  <button onClick={() => setView('login')} className="text-[#A01030] font-bold hover:underline">Log In</button>
                </p>
