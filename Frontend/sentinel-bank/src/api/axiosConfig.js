...
const mockData = {
  ...
  // --- PENDING PAYMENT REQUEST (Push Notification) ---
  paymentRequest: {
    id: 'req_88291',
    merchant: 'Amazon',
    amount: 45000.00,
  ...
  // --- ADMIN: TICKETS (Enriched for AI Analysis Card) -
  adminTickets: [
    { 
      id: '#49202', 
      user: 'Chinedu Okafor', 
  ...
  // --- ADMIN: USER LIST (For Users Module) ---
  adminUsers: [
    { id: 'u1', name: 'Reuben', email: 'reuben@nexa.ng', tier: 'Tier 3', status: 'Active', balance: '₦4,850,200.50' },
