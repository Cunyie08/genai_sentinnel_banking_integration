...
import { Smartphone, Search, ArrowRight, Users, CheckCircle } from 'lucide-react';

const AIThoughtProcess = ({ ticket }) => {
  // If no ticket is passed, we show the default "Live" view from your screenshot
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden font-sans">
      ...
      <div className="p-8 relative">
         ...
         {/* ── STEP 2: INTENT DETECTED (The Red Box) ── */}
         <div className="flex gap-6 mb-8 relative z-10">
            <div className="w-10 h-10 rounded-full bg-white border-2 border-[#A01030] flex items-center justify-center text-[#A01030] shadow-sm shrink-0">
              <Search size={18} />
            </div>
      ...
      <div className="px-6 py-4 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
        <button className="px-4 py-2 bg-white border border-red-200 text-[#A01030] rounded-lg text-xs font-bold hover:bg-red-50 transition-colors">
           ✏️ Override Manually
        </button>
